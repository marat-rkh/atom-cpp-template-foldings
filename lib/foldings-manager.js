...
export default class FoldingsManager {
    ...
    foldWithPreview(range, previewText, foldingId) {
        let text = this.textEditor.getTextInBufferRange(range);
        ...
        this.foldTemplate(this.textEditor, range, previewText, text, textVisualLength);
        this.createOverlayDecoration(this.textEditor, foldingId, range, previewText);
    }
