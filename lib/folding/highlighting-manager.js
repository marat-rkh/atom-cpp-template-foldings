...
export class HighlightingManager {
    ...
    manageFolding(foldingMarker, highlightImmediately = false) {
        this._markersAtRows.saveMarkerAtRow(foldingMarker, foldingMarker.getStartBufferPosition().row);
            ...
            handlers: {
                onTranslated: event => {
                    this._markersAtRows.updateMarkerRow(
                        marker,
                        event.oldTailBufferPosition.row,
                        event.newTailBufferPosition.row
                    );
                },
                onInvalidated: event => {
